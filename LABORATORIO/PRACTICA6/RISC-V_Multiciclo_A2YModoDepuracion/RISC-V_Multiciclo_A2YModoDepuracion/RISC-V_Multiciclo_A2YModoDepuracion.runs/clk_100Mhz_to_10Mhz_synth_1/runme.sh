...
HD_PWD='C:/hlocal/RISC-V_Multiciclo_A2YModoDepuracion/RISC-V_Multiciclo_A2YModoDepuracion.runs/clk_100Mhz_to_10Mhz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_100Mhz_to_10Mhz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_100Mhz_to_10Mhz.tcl
