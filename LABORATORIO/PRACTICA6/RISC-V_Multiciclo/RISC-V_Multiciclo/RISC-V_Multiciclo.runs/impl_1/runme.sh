...
HD_PWD='C:/UCM/TOC/TOC/LABORATORIO/PRACTICA6/RISC-V_Multiciclo/RISC-V_Multiciclo/RISC-V_Multiciclo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCVMulticiclo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISCVMulticiclo.tcl -notrace
