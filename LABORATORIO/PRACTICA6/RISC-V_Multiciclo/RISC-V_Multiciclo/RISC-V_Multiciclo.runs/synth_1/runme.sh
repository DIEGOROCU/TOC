...
HD_PWD='C:/UCM/TOC/TOC/LABORATORIO/PRACTICA6/RISC-V_Multiciclo/RISC-V_Multiciclo/RISC-V_Multiciclo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCVMulticiclo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISCVMulticiclo.tcl
