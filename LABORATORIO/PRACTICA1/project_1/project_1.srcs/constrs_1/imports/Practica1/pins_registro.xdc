...
## Switches
#set_property PACKAGE_PIN V17 [get_ports {rst[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {rst[0]}]
#set_property PACKAGE_PIN V16 [get_ports {load[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {load[0]}]
set_property PACKAGE_PIN W16 [get_ports {E[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {E[0]}]
set_property PACKAGE_PIN W17 [get_ports {E[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {E[1]}]
set_property PACKAGE_PIN W15 [get_ports {E[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {E[2]}]
set_property PACKAGE_PIN V15 [get_ports {E[3]}]					
