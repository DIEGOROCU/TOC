...
HD_PWD='C:/Users/paufr/OneDrive/Escritorio/TOC/LABORATORIO/PRACTICA2/PRACTICA2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cerrojo_sistema.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cerrojo_sistema.tcl -notrace
