...
synth_design -top cerrojo_sistema -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef cerrojo_sistema.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file cerrojo_sistema_utilization_synth.rpt -pb cerrojo_sistema_utilization_synth.pb"
