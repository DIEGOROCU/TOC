...
HD_PWD='C:/Users/paufr/OneDrive/Escritorio/TOC/LABORATORIO/PRACTICA2/PRACTICA2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cerrojo_sistema.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cerrojo_sistema.tcl
